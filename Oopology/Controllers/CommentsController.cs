...
namespace Oopology.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(OopologyContext context)
        {
            _context = context;
        }
        ...
        {
            var oopologyContext = _context.Comment.Include(c => c.Post).Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OopologyContext.Comment'  is null.");
            }
            var comment = await _context.Comment.FindAsync(id);
            if (comment != null)
            {
